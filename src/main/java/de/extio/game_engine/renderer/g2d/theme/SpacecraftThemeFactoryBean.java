...
public class SpacecraftThemeFactoryBean implements FactoryBean<Theme> {
	...
	public Theme getObject() {
		return Theme.builder()
				...
				.backgroundSelected(new HSBColor(0.2f, 0.83f, 0.50f))
				.textNormal(new HSBColor(0.71f, 0.08f, 0.80f))
				.textDisabled(new HSBColor(0.71f, 0.08f, 0.50f))
				.selectionPrimary(new HSBColor(0.2f, 0.83f, 0.7f))
				.selectionSecondary(new HSBColor(0.2f, 0.83f, 0.90f))
